...
for i = 1:NrWDs
    ...
    NrPeaks(i) = numel(findpeaks(smooth(WD(:,i)),1:NrBins,'MinPeakProminence',0.05,'MinPeakDistance',5));
...
%Lead/calm waters
class(RatioIP < 0.65 & StartLE > 30 & PP > 0.25 & NrPeaks == 1 & Ptail < 0.5 & (sigma0 > 25 | isnan(sigma0))) = 4;  
%Ice/land
class((NrPeaks > 1 | kurt > 12) & PP < 0.15 & class ~= 2 & class ~= 3) = 5;
