...
% sig_PTR      = (0.534/DDAcf.B); 
% T            = sqrt(2*pi)*sig_PTR;
% C            = 10*log10((DDAcf.c * pi * DDAcf.lambda0^2 * DDAcf.G0^2 * T) ./ ((4 * pi * R).^3 .* ((R+R_earth)/R_earth)));
% 
% gamma        = (2/log(2)) * sin((2/(1/DDAcf.theta_x + 1/DDAcf.theta_y))/2)^2;     %pp. 20
% fb           = (10/log(10)) * ((-4/gamma) * sin(CS.GEO.MPA(:)).^2);
% 
% %What is L?
% sigma0       = 10*log10(CS.Pu./Tx_Pwr) - C + 0 + 30*log10(CS.HEI./R) - fb + DDAcf.Biases.sigma0;
